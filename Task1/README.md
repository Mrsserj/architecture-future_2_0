...
- Интеграционную шину обновим, используя более современный брокер сообщений, например Apache Kafka.
	*Миграцию шины можно осуществить постепенно, сначала перейдя на брокер Kafka, а затем внедряя сервисы обработки данных Apache Flink, которые будут заменять имеющиеся в исходной системе функционал*
